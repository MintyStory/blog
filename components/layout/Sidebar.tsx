    ...
    >
              ...
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    onClick={close}
                    className="block py-2.5 pl-3 text-[15px] text-white/55 hover:text-white transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
      ...
      <div className="px-6 pb-8 pt-6 border-t border-white/8 shrink-0 space-y-4">
        ...
        <div className="flex gap-5">
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-xs text-white/40 hover:text-white transition-colors">
            GitHub
          </a>
          <a href="/rss.xml" className="text-xs text-white/40 hover:text-white transition-colors">
            RSS
          </a>
        </div>
      </div>
